...
public class SpawnerTest {
	...
	@Test
	public void equals_SameSpawner() {
		Spawner t = new Spawner(100, 10, ElementTypes.Air_Type, false, 3, true,
				150);
		assertTrue(s.equals(t));
	}

	@Test
	public void equals_differentMonsters() {
		new Player(100, 10, 25);
		Spawner t = new Spawner(100, 10, ElementTypes.Air_Type, false, 3, true,
				150);
		t.spawnMonsters();
	...
	public void equals_differentHealth() {
		Spawner t = new Spawner(42, 10, ElementTypes.Air_Type, false, 3, true,
				150);
		assertFalse(s.equals(t));
	}

	@Test
	public void equals_differentSpawning() {
		Spawner t = new Spawner(100, 10, ElementTypes.Air_Type, false, 3,
				false, 150);
		assertFalse(s.equals(t));
	}

	@Test
	public void equals_differentMaximumMonsters() {
		Spawner t = new Spawner(100, 10, ElementTypes.Air_Type, false, 0, true,
				150);
		assertFalse(s.equals(t));
	}

	@Test
	public void equals_differentBounty() {
		Spawner t = new Spawner(100, 10, ElementTypes.Air_Type, false, 3, true,
				50);
		assertFalse(s.equals(t));
	}
	...
	@Test
	public void equals_differentDamage() {
		Spawner t = new Spawner(100, 21, ElementTypes.Air_Type, false, 3, true,
				150);
		assertFalse(s.equals(t));
	}

	@Test
	public void equals_differentBossState() {
		Spawner t = new Spawner(100, 10, ElementTypes.Air_Type, true, 3, true,
				150);
		assertFalse(s.equals(t));
	}

	@Test
	public void equals_differentElementTypes() {
		Spawner t = new Spawner(100, 10, ElementTypes.Fire_Type, false, 3,
				true, 150);
		assertFalse(s.equals(t));
	}
	...
	@Test
	public void equals_ObjectNotSpawner() {
		assertFalse(s.equals(s.getElementType()));
	}

	@Test
	public void removeMonster_RandomMonster() {
		Random ran = new Random();
		Spawner t = new Spawner(100, 10, ElementTypes.Air_Type, false, 3, true,
				150);
		t.spawnMonsters();
		List<Monsters> ls = t.getMonsters();
		List<Monsters> lsBefore = new LinkedList<Monsters>(ls);
		int index = ran.nextInt(lsBefore.size() - 1);
		Monsters m = lsBefore.get(index);
		m.applyDamage(20);
		t.removeMonster(m);
		List<Monsters> lsAfter = t.getMonsters();
		assertTrue(lsBefore.size() > lsAfter.size());
		assertTrue(lsBefore.size() == lsAfter.size() + 1);
		assertFalse(lsAfter.contains(m));
	}

	@Test
	public void removeMonster_FirstMonster() {
		Spawner t = new Spawner(100, 10, ElementTypes.Air_Type, false, 3, true,
				150);
		t.spawnMonsters();
		List<Monsters> ls = t.getMonsters();
		List<Monsters> lsBefore = new LinkedList<Monsters>(ls);
		Monsters m = lsBefore.get(0);
		m.applyDamage(20);
		t.removeMonster(m);
		List<Monsters> lsAfter = t.getMonsters();
		assertTrue(lsBefore.size() > lsAfter.size());
	...
	@Test
	public void removeMonster_Null() {
		Spawner t = new Spawner(100, 10, ElementTypes.Air_Type, false, 3, true,
				150);
		t.spawnMonsters();
		assertFalse(t.removeMonster(null));
	}

	@Test
	public void removeMonster_NotMonstersClass() {
		Player p = new Player(1, 1, 1);
		Spawner t = new Spawner(100, 10, ElementTypes.Air_Type, false, 3, true,
				150);
		t.spawnMonsters();
		assertFalse(t.removeMonster(p));
	}

	@Test
	public void removeMonster_NotContained() {
		Monsters m = new Monsters(1000, 100, ElementTypes.Air_Type, false,
				AppearanceTypes.Standard_Type, 10);
		Spawner t = new Spawner(100, 10, ElementTypes.Air_Type, false, 3, true,
				150);
		t.spawnMonsters();
		assertFalse(t.removeMonster(m));
	}
}
