...
public class Spawner extends Monsters {
	...
	/**
	 * Return true if the specified Monster has successfully been removed from
	 * the Spawner
	 * 
	 * @param monster
	 * @return removed
	 */
	public boolean removeMonster(Monsters monster) {
		if (monster != null) {
			if (monster.getClass() == Monsters.class) {
				if (monsterList.contains(monster)) {
					if (this.monsterList.remove(monster)) {
						return true;
					}
				}
			}
